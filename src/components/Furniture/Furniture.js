  ...
  const furnitureData = [
    {
      ...
      firstTitle: "Dreamy Bedrooms: ",
      secondTitle: "Where Comfort Meets Style.",
    },
    {
      mirrorPara:
      ...
      firstTitle: "Reflecting Elegance: ",
      secondTitle: "Mirrors That Illuminate Your Space.",
    },
    {
      dinningTable:
      ...
      firstTitle: "Savor the Moments: ",
      secondTitle: "Exceptional Dining Tables for Timeless Gatherings.",
    },
  ];
  ...
  return (
    <div class="container marketing">
      ...
      <FurnitureSection
        ...
        firstTitle={furnitureData[0].firstTitle}
        secondTitle={furnitureData[0].secondTitle}
      />
      <FurnitureSection
        className={"col-md-7 order-md-2"}
        srcImage={Mirror}
        furniturePara={furnitureData[1].mirrorPara}
        firstTitle={furnitureData[1].firstTitle}
        secondTitle={furnitureData[1].secondTitle}
      />
      <FurnitureSection
        className={"col-md-7"}
        srcImage={DinningTable}
        furniturePara={furnitureData[2].dinningTable}
        firstTitle={furnitureData[2].firstTitle}
        secondTitle={furnitureData[2].secondTitle}
      />
    </div>
  );
}
